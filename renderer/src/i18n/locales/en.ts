const en = {
  ...
  modal: {
    ...
    providerTypes: {
      ...
      chatgptOfficial: 'ChatGPT (official)',
    },
    chatgptOfficialGroupLabel: 'ChatGPT (official)',
    chatgptOfficialModelHint: 'Routed through your signed-in ChatGPT account.',
    chatgptOfficialModelPicker: 'Model',
    userModelGroupLabel: 'My configurations',
  },
  chatgptAuth: {
    title: 'ChatGPT account',
    description: 'Authorize to use OpenAI models without managing an API key.',
    statusSignedOut: 'Not authorized',
    statusSignedIn: 'Authorized',
    statusSignedInAs: 'Authorized as {email}',
    loginButton: 'Authorize',
    loginPending: 'Waiting for browser…',
    logoutButton: 'Revoke',
    portInUse: 'Port 1455 is already in use. Close any other Codex-style login session and try again.',
    manualPasteHint: 'Port 1455 is in use (usually because Codex CLI is running), so the callback can\'t be received automatically. Finish the OAuth flow in your browser, then paste the redirected URL below (or just the code value).',
    manualPasteBindError: 'Port bind failed: {err}',
    ...
    agentUnavailable: 'ChatGPT not authorized — this agent is unavailable',
    usageTitle: 'Quota usage',
    usageLoading: 'Loading…',
    usageRefresh: 'Refresh',
    usageNotAvailable: 'No usage data yet. Send a message and the panel will populate.',
    usagePrimary: '5-hour quota',
    usageSecondary: '7-day quota',
    usageResetSec: 'resets in {sec}s',
    usageResetMin: 'resets in {min}m',
    usageResetHr: 'resets in {hr}h',
    usageResetDay: 'resets in {day}d',
  },
  welcome: {
