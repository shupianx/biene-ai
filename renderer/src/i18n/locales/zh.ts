...
const zh: Messages = {
  ...
  modal: {
    ...
    providerTypes: {
      ...
      chatgptOfficial: 'ChatGPT 官方',
    },
    chatgptOfficialGroupLabel: 'ChatGPT 官方',
    chatgptOfficialModelHint: '通过已登录的 ChatGPT 账户调用 OpenAI 模型。',
    chatgptOfficialModelPicker: '模型',
    userModelGroupLabel: '我的配置',
  },
  chatgptAuth: {
    title: 'ChatGPT账户',
    description: '授权后无需手动填写 API Key，即可使用 OpenAI 模型。',
    statusSignedOut: '未授权',
    statusSignedIn: '已授权',
    statusSignedInAs: '已授权：{email}',
    loginButton: 'ChatGPT 授权',
    loginPending: '等待浏览器…',
    logoutButton: '撤销授权',
    portInUse: '本机 1455 端口已被占用。请关闭其他正在登录 Codex 的程序后重试。',
    manualPasteHint: '本机 1455 端口已被占用（通常是 Codex CLI 在跑），无法自动接收回调。请在浏览器完成授权后，把跳转后的整段 URL 粘贴到下面（也可只粘贴 code 参数）。',
    manualPasteBindError: '端口绑定失败：{err}',
    manualPastePlaceholder: 'http://localhost:1455/auth/callback?code=…&state=…',
    manualPasteSubmit: '提交授权码',
    failed: '授权失败，请稍后重试。',
    cancelled: '已取消授权。',
    agentUnavailable: 'ChatGPT 无授权，该智能体暂不可用',
    usageTitle: '额度使用',
    usageLoading: '查询中…',
    usageRefresh: '刷新',
    usageNotAvailable: '暂无配额数据。发一条消息后这里会显示当前用量。',
    usagePrimary: '5小时额度',
    usageSecondary: '7天额度',
    usageResetSec: '{sec} 秒后重置',
    usageResetMin: '{min} 分钟后重置',
    usageResetHr: '{hr} 小时后重置',
    usageResetDay: '{day} 天后重置',
  },
  welcome: {
    title: '欢迎使用 Biene',
