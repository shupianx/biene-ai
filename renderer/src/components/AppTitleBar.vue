  ...
  >
    ...
    <div class="titlebar-actions" @click.stop>
      ...
      <div v-if="menuOpen" ref="menuRef" class="settings-menu">
        <button class="menu-item" type="button" @click="onSettings">Settings</button>
        <div class="menu-toggle-row">
          <span class="menu-toggle-label">Dark mode</span>
          <ToggleSwitch v-model="darkMode" label="Dark mode" />
        </div>
        <button class="menu-item" type="button" @click="onAbout">About Biene</button>
      </div>
    </div>
  </header>
</template>
