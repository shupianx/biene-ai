...
<p align="center">
  本地优先的 Agent 助手桌面应用 · Local-first AI coding assistant
</p>
...
Biene 是一个桌面端的多智能体 Agent 助手。把"和模型对话"、"在工作区改代码"、"灵活组装搭配多智能体"、"在多个 agent 之间分发任务"等环节做成一体的本地体验——没有云端会话，所有历史和配置都留在你机器上。
